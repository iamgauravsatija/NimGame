...
def main():
    ...
    #check_win_con1("P1",k,piles)
    #check_win_con4("P1",k,piles)
    ...
    while True:
        if turnOrder:
            ...
            check_win_con1("P1",k,piles)
            check_win_con2("P1", k, piles)
            check_win_con3("P1", k, piles)
            check_win_con4("P1", k, piles)

            enemy_turn(piles)
            check_win_con1("P2",k,piles)
            check_win_con2("P2", k, piles)
            check_win_con3("P2", k, piles)
            check_win_con4("P2", k, piles)
        else:
            enemy_turn(piles)
            check_win_con1("P2",k,piles)
            check_win_con2("P2", k, piles)
...
def check_win_con1(playerName,k,objectPiles):
...
def check_win_con2(playerName,k,objectPiles):
...
def check_win_con3(playerName, k, objectPiles):
...
def check_win_con4(playerName,k,objectPiles):
